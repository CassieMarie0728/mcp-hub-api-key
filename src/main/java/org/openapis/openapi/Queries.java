...
import org.openapis.openapi.models.operations.PostQueryRequestBuilder;
 ...
 */
public class Queries implements
            MethodCallPostQuery {

    private final SDKConfiguration sdkConfiguration;

    Queries(SDKConfiguration sdkConfiguration) {
     ...
     * 
     * <p>Send a query or command to an MCP server
     * 
     * @return The call builder
     */
    public PostQueryRequestBuilder postQuery() {
        return new PostQueryRequestBuilder(this);
    }
     ...
     */
    public PostQueryResponse postQuery(
            QueriesBody request,
        ...
        PostQueryResponse.Builder _resBuilder = 
            PostQueryResponse
                .builder()
        ...
        PostQueryResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                InlineResponse2008 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<InlineResponse2008>() {});
                _res.withInlineResponse2008(Optional.ofNullable(_out));
                return _res;
            } else {
