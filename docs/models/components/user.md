...
```typescript
import { User } from "@cassie-marie/mcp-hub-api-typescript/models/components";
...
| `role`                                                                                        | [components.Role](../../models/components/role.md)                                            | :heavy_minus_sign:                                                                            | User role in the system                                                                       | user                                                                                          |
